// نسخه جدید (v0.3.1): برطرف‌سازی اعلان‌های تکراری و اصلاح متغیرهای ثابتی سیستم
export const SYSTEM_VERSION = '0.3.1';
export const LAST_UPDATE_PERSIAN = 'حل مشکل تعاریف تکراری متغیرهای نسخه سیستم و اصلاح کامپایل ورکر.';
